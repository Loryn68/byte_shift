  ...
  return (
    <div className="container mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Comprehensive user registration and role-based access control</p>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="users" className="space-y-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">Manage hospital staff accounts and credentials</p>
            </div>
            <Button onClick={() => {
              setEditingUser(null);
              resetForm();
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8 text-gray-500">
                Role-based access control matrix will be configured here
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="audit" className="space-y-6">
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8 text-gray-500">
                Comprehensive audit trail logging for all user activities
              </div>
            </CardContent>
          </Card>
        </TabsContent>
