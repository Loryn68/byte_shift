...
export default function OutpatientQueue() {
  ...
  const getPatientStatus = (patient: Patient) => {
    ...
    return "triaged-needs-billing"; // Changed from "needs-billing" to indicate patient is triaged
  };
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case "triaged-needs-billing":
        return <Badge className="bg-blue-100 text-blue-800">Triaged - Ready for Billing</Badge>;
      case "needs-billing":
